...
export default function Contact(){
    ...
    <div className="md:flex space-x-10 text-center justify-center items-center m-2">
                    ...
                    <div className="flex space-x-3 py-3 ml-9 md:ml-0"><div className=" "><Image className="  w-8 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 " src="/location-pin-svgrepo-com.svg" alt="" width={500} height={500}/></div><span className=" py-1 font-semibold text-lg">Joher Town Near Jinnah Hospital Lahore</span></div>
                    <div className="flex space-x-3 py-3"><div className=" "><Image className=" w-8 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 " src="/phone-call-svgrepo-com.svg" alt="" width={500} height={500} /></div><span className=" py-1 font-semibold text-lg">+923087267910</span></div>
                    <div className="flex space-x-3 py-3"><div className=" "><Image className=" w-8 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 " src="/email-1-svgrepo-com.svg" alt="" width={500} height={500}/></div><span className=" py-1 font-semibold text-lg">sheerazahmad.cs@gmail.com</span></div>
