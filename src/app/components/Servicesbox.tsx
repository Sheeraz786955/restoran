    ...
    return <div className="main bg-gray-100 md:pl-8 p-3 ">
        <div className="container py-10 space-y-5 md:space-y-0 bg-gray-100 md:flex md:space-x-4">
            <div className="left bg-white md:w-1/3 p-8 hover:bg-[#fea116] hover:text-white">
                <div className="py-3"><img src="icons/user-profile-svgrepo-com.svg" alt="" className="w-28 " /></div>
            ...
            <div className="py-3"><img src="icons/plate-fork-spon-svgrepo-com.svg" alt="" className="w-28" /></div>
