        ...
        <div className="container md:flex md:w-full md:p-2 mt-2">
            <div className="left md:w-1/2 ">
                <div className="one flex space-x-6 p-2">
                    <div className=" w-24 h-24"><Image className="" src="/menu-1.jpg" alt="" width={500} height={500}/></div>
                ...
                <div className="one flex space-x-6 p-2">
                    <div className=" w-24 h-24"><Image className="" src="/menu-2.jpg" alt="" width={500} height={500}/></div>
                ...
                <div className="one flex space-x-6 p-2">
                    <div className=" w-24 h-24"><Image className="" src="/menu-3.jpg" alt="" width={500} height={500}/></div>
                ...
                <div className="one flex space-x-6 p-2">
                    <div className=" w-24 h-24"><Image className="" src="/menu-4.jpg" alt="" width={500} height={500}/></div>
            ...
            <div className="right md:w-1/2">
                <div className="one flex space-x-6 p-2">
                    <div className=" w-24 h-24"><Image className="" src="/menu-5.jpg" alt="" width={500} height={500}/></div>
                ...
                <div className="one flex space-x-6 p-2">
                    <div className=" w-24 h-24"><Image className="" src="/menu-6.jpg" alt="" width={500} height={500} /></div>
                ...
                <div className="one flex space-x-6 p-2">
                    <div className=" w-24 h-24"><Image className="" src="/menu-7.jpg" alt="" width={500} height={500}/></div>
                ...
                <div className="one flex space-x-6 p-2">
                    <div className=" w-24 h-24"><Image className="" src="/menu-8.jpg" alt="" width={500} height={500}/></div>
