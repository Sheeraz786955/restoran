    ...
    return <div className="main">
        ...
        <div className="container py-10 space-y-5 md:space-y-0 bg-gray-100 md:flex md:space-x-4 justify-center items-center">
            <div className="left bg-white md:w-1/3 p-8 hover:bg-[#fea116] hover:scale-110 duration-300 hover:text-white">
                <div className="py-3"><Image src="/cutlery-set-of-eating-tools-svgrepo-com.svg" alt="" className="w-28 " /></div>
            ...
            <div className="py-3"><Image src="/car-svgrepo-com.svg" alt="" className="w-28" /></div>
                <h1 className=" font-bold text-2xl py-2">Drive Food</h1>
                <p>You can get your food on your car<br/>Enjoy our services </p>
            </div>
            <div className="mid2 bg-white md:w-1/3 p-8 hover:bg-[#fea116] hover:scale-110 duration-300 hover:text-white">
            <div className="py-3"><Image src="/shopping-cart-svgrepo-com.svg" alt="" className="w-28" /></div>
            ...
            <div className="py-3"><Image src="/customer-service-mic-svgrepo-com.svg" alt="" className="w-28" /></div>
