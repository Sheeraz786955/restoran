    ...
    <div className="container md:flex h-fit  bg-[#0f172b]">
        ...
        <div className="right w-full md:w-1/2 ">
            <form action="" className="p-11 md:pl-48 w-fit">
                ...
                <input className="p-3 w-80 mb-3 mt-1 rounded-2xl" type="datetime-local" placeholder="Date & Time"/><br />
                <span className="font-semibold text-xl text-white">Number of Persons</span><br />
                <select className="p-3 w-80 mb-3 mt-1 rounded-2xl" id="persons" name="cars">
                ...
                <textarea className="p-3 w-80 mb-3 mt-1 rounded-2xl" name="message" placeholder="Special request"/><br />
